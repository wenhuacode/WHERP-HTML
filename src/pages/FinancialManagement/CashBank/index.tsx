...
import {getCashBank} from "@/services/ant-design-pro/accounting_subject";
    ...
    <PageContainer>
      <ProCard split="vertical" size={'small'}>
        ...
        <ProCard colSpan="73%" size={'small'}  >
          <SubsidiaryLedgerlList id={id} dateRange={dateRange}/>
        </ProCard>
      </ProCard>
    </PageContainer>
  );
