...
import { ProductSaleQueryApi} from "@/services/ant-design-pro/data-center/sale/sale";
import dayjs from 'dayjs';
import {Table} from "antd";
import SelectCustomer from "@/pages/BusinessCenter/order/SelectCustomer/SelectCustomer";
import {history} from "@@/core/history";

const ProductSaleQueryHandler = () => {
    ...
    return (
      <Table.Summary fixed>
        <Table.Summary.Row>
          ...
          <Table.Summary.Cell index={11}>{data.gift_qty}</Table.Summary.Cell>
          <Table.Summary.Cell index={10}>{data.gift_total.toFixed(2)}</Table.Summary.Cell>
...
export default ProductSaleQueryHandler;
